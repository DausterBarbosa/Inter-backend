...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.signin = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, userService, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, email = _a.email, password = _a.password;
                        userService = new user_service_1.default();
                        return [4 /*yield*/, userService.signin({ email: email, password: password })];
                    case 1:
                        user = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userService = new user_service_1.default();
                        return [4 /*yield*/, userService.signup(req.body)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.status(200).json(user)];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userService = new user_service_1.default();
                        return [4 /*yield*/, userService.me(req.user)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.status(200).json(user)];
                }
